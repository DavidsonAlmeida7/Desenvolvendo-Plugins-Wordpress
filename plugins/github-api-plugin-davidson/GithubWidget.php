...
class GithubWidget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => 'Widget do plugin Github - Davidson Almeida',
		);
		parent::__construct( 'githubwidget', 'Github Widget - Davidson Almeida', $widget_ops);
	}
...
?>          
        ...
        <div class="usuario">
            ...
            <p><strong>API URL:</strong> <?php echo $usuario->url; ?></p>
            <p><strong>URL:</strong> <?php echo $usuario->html_url; ?></p>
            <hr>
        </div>
	...
	public function form($instance) {
       ...
       ?> 
        ...
        <label>Quantidade de repositórios:</label><br>
